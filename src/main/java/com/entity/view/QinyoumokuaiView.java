...
public class QinyoumokuaiView extends QinyoumokuaiEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 动态类型的值
		*/
		private String qinyoumokuaiValue;
	...
	public QinyoumokuaiView() {

	}

	public QinyoumokuaiView(QinyoumokuaiEntity qinyoumokuaiEntity) {
		try {
			BeanUtils.copyProperties(this, qinyoumokuaiEntity);
			...
			* 获取： 动态类型的值
			*/
			public String getQinyoumokuaiValue() {
				return qinyoumokuaiValue;
			}
			/**
			* 设置： 动态类型的值
			*/
			public void setQinyoumokuaiValue(String qinyoumokuaiValue) {
				this.qinyoumokuaiValue = qinyoumokuaiValue;
			}
