...
public class JiatingqinzishipinView extends JiatingqinzishipinEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 视频类型的值
		*/
		private String jiatingqinzishipinValue;
	...
	public JiatingqinzishipinView() {

	}

	public JiatingqinzishipinView(JiatingqinzishipinEntity jiatingqinzishipinEntity) {
		try {
			BeanUtils.copyProperties(this, jiatingqinzishipinEntity);
			...
			* 获取： 视频类型的值
			*/
			public String getJiatingqinzishipinValue() {
				return jiatingqinzishipinValue;
			}
			/**
			* 设置： 视频类型的值
			*/
			public void setJiatingqinzishipinValue(String jiatingqinzishipinValue) {
				this.jiatingqinzishipinValue = jiatingqinzishipinValue;
			}
