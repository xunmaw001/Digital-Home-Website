...
var indexNav = [
    ...
    {
        name: '家庭亲子视频',
        url: './pages/jiatingqinzishipin/list.html'
    },
    {
        name: '家庭日记',
        url: './pages/jiatingriji/list.html'
    },
    {
        name: '新闻信息',
    ...
    {
        name: '亲友动态',
        url: './pages/qinyoumokuai/list.html'
    },

]

var adminurl =  "http://localhost:8080/shuzijiatingwangzhan/admin/dist/index.html#/login";
