  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='yonghu'"  label='家庭' prop="yonghuTypes">
                 <el-select v-model="ruleForm.yonghuTypes"  placeholder='请选择家庭'>
                     <el-option
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='yonghu'"  label='身份' prop="shenfenTypes">
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.yonghuTypes)&& 'yonghu'==this.flag){
                             this.$message.error('家庭不能为空');
                             return
                         }

                         if((!this.ruleForm.shenfenTypes)&& 'yonghu'==this.flag){
