        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="家庭" prop="yonghuTypes">
                        <el-select v-model="ruleForm.yonghuTypes" :disabled="ro.yonghuTypes" placeholder="请选择家庭">
                            <el-option
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="身份" prop="shenfenTypes">
                        <el-select v-model="ruleForm.shenfenTypes" :disabled="ro.shenfenTypes" placeholder="请选择身份">
                            <el-option
                    ...
                    <div v-else>
                        <el-form-item class="input" label="身份" prop="shenfenValue">
                        <el-input v-model="ruleForm.shenfenValue"
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   yonghuTypes: [
                              { required: true, message: '家庭不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
